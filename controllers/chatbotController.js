...
handleFileUpload: async function(req, res) {
    try {
        ...
        // Get user from the session or JWT token
        const token = req.headers['authorization']?.split('Bearer ')[1]; // Assuming the token is sent in Authorization header
