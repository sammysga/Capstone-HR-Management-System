...
const hrController = {
    getHRDashboard: async function(req, res) {
        ...
        try {
            ...
            const fetchAttendanceLogs = async (selectedDate = null) => {
            ...
            const selectedDate = req.query.selectedDate; // Get the selected date from the query parameters, if provided
